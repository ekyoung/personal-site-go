...
func NewHardcodedTripRepository() *HardcodedTripRepository {
	...
	allTrips = append(allTrips, &Trip{
		...
		Slides: SlidesInfo{
			IndexFileUrl: "http://img.ethanyoung.us/Alaska2005/Alaska2005Index.xml",
			RootUrl:      "http://img.ethanyoung.us/Alaska2005",
		},
	})
	...
	allTrips = append(allTrips, &Trip{
		...
		Slides: SlidesInfo{
			IndexFileUrl: "http://img.ethanyoung.us/Southwest2007/Southwest2007Index.xml",
			RootUrl:      "http://img.ethanyoung.us/Southwest2007",
		},
	})
	...
	allTrips = append(allTrips, &Trip{
		...
		Slides: SlidesInfo{
			IndexFileUrl: "http://img.ethanyoung.us/Mexico2013/Mexico2013Index.xml",
			RootUrl:      "http://img.ethanyoung.us/Mexico2013",
		},
	})
	...
	allTrips = append(allTrips, &Trip{
		...
		Slides: SlidesInfo{
			IndexFileUrl: "http://img.ethanyoung.us/MoabMay2006/MoabMay2006Index.xml",
			RootUrl:      "http://img.ethanyoung.us/MoabMay2006",
		},
	})
	...
	allTrips = append(allTrips, &Trip{
		...
		Slides: SlidesInfo{
			IndexFileUrl: "http://img.ethanyoung.us/UncleBudHut2007/UncleBudHut2007Index.xml",
			RootUrl:      "http://img.ethanyoung.us/UncleBudHut2007",
		},
	})
	...
	allTrips = append(allTrips, &Trip{
		...
		Slides: SlidesInfo{
			IndexFileUrl: "http://img.ethanyoung.us/BettyBearHut2006/BettyBearHut2006Index.xml",
			RootUrl:      "http://img.ethanyoung.us/BettyBearHut2006",
		},
	})
	...
	allTrips = append(allTrips, &Trip{
		...
		Slides: SlidesInfo{
			IndexFileUrl: "http://img.ethanyoung.us/BinghamCanyonMine/Mine2005Index.xml",
			RootUrl:      "http://img.ethanyoung.us/BinghamCanyonMine",
		},
	})
	...
	allTrips = append(allTrips, &Trip{
		...
		Slides: SlidesInfo{
			IndexFileUrl: "http://img.ethanyoung.us/DinosaurNM2005/DinosaurNM2005Index.xml",
			RootUrl:      "http://img.ethanyoung.us/DinosaurNM2005",
		},
	})
